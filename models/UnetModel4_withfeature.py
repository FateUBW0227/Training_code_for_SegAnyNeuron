...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        # create encoder path
        self.encoders = create_encoders(in_channels - 1, f_maps, basic_module, conv_kernel_size, conv_padding, layer_order,
    ...
    def forward(self, x):
        ...
        for decoder, encoder_features1, encoder_features2, addDec in zip(self.decoders, encoders_features, encoders_features2, self.addDec[1:]):
            ...
            encoder_features = torch.cat([encoder_features1, encoder_features2 * ratio], dim=1)
